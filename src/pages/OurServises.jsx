	...
	return (
		<div className="section-container my-16">
			<div className="flex flex-col md:flex-row items-center justify-between gap-12">
				...
				<div className="md:w-1/2">
					<div className="grid sm:grid-cols-2 grid-cols-1 gap-8 self-center">
						{serviceLists &&
							serviceLists?.map((service) => (
								<div
									key={service.id}
									className="shadow-md rounded-sm py-5 px-4 text-center space-y-2 text-green cursor-pointer hover:scale-105 transition-all duration-200"
								>
									<img
										src={service?.img}
										alt=""
